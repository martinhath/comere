...
impl<T> Atomic<T> {
    ...
    ///
    /// ```
    /// use comerec-rc::{self as epoch, Atomic};
    ...
    ///
    /// ```
    /// use comerec-rc::{self as epoch, Atomic, Ptr};
    /// use std::sync::atomic::Ordering::SeqCst;
    ///
    /// let a = Atomic::new(1234);
    ...
    ///
    /// ```
    /// use comerec-rc::{self as epoch, Atomic, Owned};
    /// use std::sync::atomic::Ordering::SeqCst;
    ///
    /// let a = Atomic::null();
    ...
    ///
    /// ```
    /// use comerec-rc::{self as epoch, Atomic, Owned, Ptr};
    /// use std::sync::atomic::Ordering::SeqCst;
    ///
    /// let a = Atomic::new(1234);
    /// epoch::pin(|scope| {
...
impl<T> Owned<T> {
    ...
    ///
    /// ```
    /// use comerec-rc::{self as epoch, Owned};
    ///
    /// let o = Owned::new(1234);
    /// epoch::pin(|scope| {
